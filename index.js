...
- /promote: promote your discord or youtube
...
- /troll: troll a user (premium only)
...
- /warn [user] [reason]
- /warnings: get a list of warnings}]
  `,
});
...
bot.command({
  ...
  code: `
$sendEmbed[$authorID;{color:#ff0000;description:Here are more commands:
- /clear-false-warnings: clear all false warnings
- /discord: get an invite link to our discord
...
bot.command({
  name: "help3",
  description: "Display even more commands",
  code: `
$sendEmbed[$authorID;{color:#ff0000;description:Here are more commands:
- /unban [reason]
- /unmute [reason]
...
- /set-nick [user] [name] (premium only): set a nickname for a user
...
- /leave-image: set the leave image (premium only)
- /join-channel: set the join channel
- /leave-channel: set the leave channel
- /join-vc: let the bot join a vc
...
- /staffchat-add: add a staffchat
- /staffchat-list: get a list of staff chats
